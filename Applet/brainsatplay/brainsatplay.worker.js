...
;// CONCATENATED MODULE: ./src/libraries/js/src/utils/gpu/gpuUtils-functs.js
...
;// CONCATENATED MODULE: ./src/libraries/js/src/utils/gpu/gpuUtils.js
...
/* harmony export */ });
/* harmony import */ var _gpu_gpuUtils_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(9);
/* harmony import */ var _mathUtils_Math2__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(675);
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return __webpack_require__(737)(url);
    ...
    this.callbacks = [{
      ...
      callback: function callback(args) {
        if (_typeof(args) === 'object') {
          Object.keys(args).forEach(function (key) {
            _this[key] = args[key]; //variables will be accessible in functions as this.x or this['x']

            if (_this.threeUtil) _this.threeUtil[key] = args[key];
          });
          return true;
        } else return false;
      }
      ...
      callback: function callback(args) {
        ...
        if (_this.animating) {
          ...
          cancelAnimationFrame(_this.animation);
          setTimeout(function () {
            _this.checkCallbacks('setupAnim');
...
webpackEmptyAsyncContext.id = 737;
...
(() => {
"use strict";
/* harmony import */ var _workerCallbacks__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(920);
